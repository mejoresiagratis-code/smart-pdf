...
- Si el conjunto incluye un documento de empresa (tarjeta NIF/CIF, certificado censal IAE de EMPRESA, escritura, Modelo 036) Y ADEMÁS un documento centrado en una persona física (DNI/NIE/pasaporte, o un certificado censal a título individual — reconocible porque menciona IRPF, no Impuesto de Sociedades, y su NIF/NIE no tiene letra inicial de CIF), entonces esa persona física es el REPRESENTANTE de la empresa (no un titular autónomo). En el documento de esa persona, propón su nombre en "Nombre representante" y su número en "NIF representante" — NO en "Nombre  Razón Social" ni en "NIE" (empresa), y NO propongas su domicilio/actividad personal como los de la empresa.
- Si el conjunto NO contiene documento de empresa alguno, y el documento actual es de una persona física (DNI/NIE, o censal individual con IRPF), entonces sí es titular autónomo — sigue las reglas de autónomo del prompt (sin representante), y su domicilio/actividad SÍ son los del distribuidor.
- Regla de nombres de archivo: pistas típicas — "cif*"/"nif*"/"escritura*"/"036*"/"iae*"/"censal*" pueden ser de empresa O de persona física autónoma; para saber cuál de las dos, mira el contenido (IRPF = persona, Impuesto de Sociedades = empresa; letra inicial del NIF/CIF). "dni*"/"nie*"/"tie*"/"permiso*"/nombres con formato "IMG_..." o "WA*" suelen ser DNI/NIE/pasaporte de persona.
""".trimIndent() + "\n\n"
        } else ""
