...
android {
    namespace = "com.mejoresiagratis.rellenador"
    compileSdk = 35
    ...
    defaultConfig {
        ...
        targetSdk = 35
        versionCode = 24
        versionName = "0.5.7-documentacion-blob-acordeon-progreso-vivo"
        testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"

        // Base URL of your PHP proxy. Override per build type.
        buildConfigField("String", "PROXY_BASE_URL", "\"https://mejoresiagratis.com/pdf/\"")
    }
...
dependencies {
    ...
    // Networking (mirrors ai-proxy.php contract)
    ...
    // PDF AcroForm filling — PdfBox port for Android
    implementation("com.tom-roush:pdfbox-android:2.0.27.0")

    // DataStore replaces localStorage (keys, history, profile)
